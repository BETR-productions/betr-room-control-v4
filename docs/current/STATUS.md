...
- `0.3.31.9` is now the current staged date-line build for publish:
  - planned release: `https://github.com/BETR-productions/betr-room-control-v2/releases/tag/v0.3.31.9`
  - assets:
    - `BETR-Room-Control-v0.3.31.9.zip`
    - `BETR-Room-Control-v0.3.31.9.dmg`
  ...
  - publication uses explicit updater sequence `2026033109` so in-app update can advance cleanly from the bridge rescue line
...
- Important release truth:
  ...
  - the current staged date-line release is `.3.31.9`, canonicalized to `0.3.31.9`
  - explicit updater sequences `2026033009`, `2026033010`, `2026033011`, `2026033012`, `2026033101`, `2026033102`, `2026033103`, `2026033104`, `2026033105`, `2026033106`, `2026033107`, `2026033108`, and `2026033109` are what let the bridge rescue hand off cleanly across the date-line releases
