...
public final class RoomControlWorkspaceStore: ObservableObject {
    ...
    public var discoveryAggregateStatus: DiscoveryAggregateStatus {
        DiscoveryServerPresentationBuilder.aggregate(
            configuredText: hostDraft.discoveryServersText,
            runtimeRows: hostValidation.discoveryServers,
            mdnsEnabled: hostDraft.mdnsEnabled
        )
    }
    ...
    public var effectiveDiscoveryNextAction: String {
        if discoveryAggregateStatus.usesMDNSOnly {
        ...
        performAction(
            ...
            onSuccess: {
                ...
                await self.coreAgentBootstrapper.markManagedAgentRestartRequired(
                    reason: .hostApply,
                    expectedConfigFingerprint: self.hostValidation.expectedConfigFingerprint ?? self.hostValidation.runtimeConfigFingerprint
                )
